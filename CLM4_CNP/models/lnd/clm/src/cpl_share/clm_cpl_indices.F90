...
!
  ...
  integer, public ::index_l2x_Fall_fc13o2_lnd ! c13o2 flux **For testing set to 0, 
  ...
  integer, public ::index_x2l_Sa_c13o2diag    ! bottom atm level diagnostic c13o2,
                                              ! added by JFM and DMR for C13, 08/22/11
...
!-----------------------------------------------------------------------
    ...
    ! added by JFM and DMR for C13, 08/22/11
    index_l2x_Fall_fc13o2_lnd = mct_avect_indexra(l2x,'Fall_fc13o2_lnd',perrwith='quiet')
    ...
    ! added by JFM and DMR for C13, 08/22/11
    index_x2l_Sa_c13o2diag  = mct_avect_indexra(x2l,'Sa_c13o2diag',perrwith='quiet')
