...
! !LOCAL VARIABLES:
    ...
    real(r8) :: c13o2_ppmv_diag      ! temporary added by JFM and DMR for C13, 08/22/11
    real(r8) :: co2_ppmv_prog        ! temporary
    real(r8) :: co2_ppmv_val         ! temporary
    real(r8) :: c13o2_ppmv_val       ! temporary added by JFM and DMR for C13, 08/22/11
...
#if (defined C13)
        ! deleted and added by JFM for C13, 10/21/11
	if (index_x2l_Sa_c13o2diag /= 0) then 
	  c13o2_ppmv_diag = x2l_l%rAttr(index_x2l_Sa_c13o2diag,i)  !co2 atm state diagnostic
	else
	  c13o2_ppmv_diag = co2_ppmv_val*c13ratio
	end if
	c13o2_ppmv_val = c13o2_ppmv_diag
		 
        a2l%forc_pc13o2(g) = c13o2_ppmv_val * 1.e-6_r8 * a2l%forc_pbot(g)
!        write(iulog,*), 'mao3',index_x2l_Sa_co2diag, index_x2l_Sa_c13o2diag
!        write(iulog,*), 'mao4',co2_ppmv, c13ratio
!        write(iulog,*), 'mao5',co2_ppmv_val * c13ratio, c13o2_ppmv_diag
!        write(iulog,*), 'mao6',x2l_l%rAttr(index_x2l_Sa_c13o2diag,i), x2l_l%rAttr(index_x2l_Sa_co2diag,i), co2_type_idx,i 
#endif	 
     end do
