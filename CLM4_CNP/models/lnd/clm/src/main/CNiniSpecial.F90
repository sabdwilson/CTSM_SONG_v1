...
!! add phosphorus 
   call CNSetCphos(num_specialc, specialc, 0._r8, clm3%g%l%c%cphos)
   call CNSetCphof(num_specialc, specialc, 0._r8, clm3%g%l%c%cphof)
...
!! add phosphorus
   call CNSetPphos(num_specialc, specialc, 0._r8, clm3%g%l%c%cphos%pphos_a)
   call CNSetPphof(num_specialc, specialc, 0._r8, clm3%g%l%c%cphof%pphof_a)
...
!! add phosphorus
   call CNSetPphos(num_specialp, specialp, 0._r8, clm3%g%l%c%p%pphos)
   call CNSetPphof(num_specialp, specialp, 0._r8, clm3%g%l%c%p%pphof)
   ...
   do fc = 1,num_specialc
	  ...
	  clm3%g%l%c%cnf%dwt_nloss(c) = 0._r8
          ...
          !!! add phosphorus : 
	  clm3%g%l%c%cphos%seedp(c) = 0._r8
	  clm3%g%l%c%cphos%prod10p(c) = 0._r8	  
	  clm3%g%l%c%cphos%prod100p(c) = 0._r8	  
	  clm3%g%l%c%cphos%totprodp(c) = 0._r8	  
