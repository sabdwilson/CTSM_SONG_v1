...
!-----------------------------------------------------------------------
  ...
  ! Adding isotope code
#if (defined C14)
  !use C14 in place of C13 
  real(r8), parameter :: preind_atm_del13c = 0.0   !preindustrial value for atmospheric del14C, modified by JFM and DMR 11/7/2012
  real(r8), parameter :: preind_atm_ratio = SHR_CONST_C14 + (preind_atm_del13c * SHR_CONST_C14)/1000.0  !14C/12C
  real(r8) :: c13ratio = preind_atm_ratio/(1.0+preind_atm_ratio) !14C/(12+14)C
#else
  real(r8), parameter :: preind_atm_del13c = -6.50293   !preindustrial value for atmospheric del13C, modified by JFM and DMR 11/7/2012	
