...
!         ptr_pft=clm3%g%l%c%p%pphos%deadcrootp_xfer, default='inactive')
    ...
    call hist_addfld1d (fname='M_LIVECROOTP_STORAGE_TO_LITTER', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%m_livecrootp_storage_to_litter, default='inactive')
    ...
    call hist_addfld1d (fname='M_LIVECROOTP_XFER_TO_LITTER', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%m_livecrootp_xfer_to_litter, default='inactive')
    ...
    call hist_addfld1d (fname='M_LIVECROOTP_STORAGE_TO_FIRE', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%m_livecrootp_storage_to_fire, default='inactive')
    ...
    call hist_addfld1d (fname='M_LIVECROOTP_XFER_TO_FIRE', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%m_livecrootp_xfer_to_fire, default='inactive')
    ...
    call hist_addfld1d (fname='LIVECROOTP_XFER_TO_LIVECROOTP', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%livecrootp_xfer_to_livecrootp, default='inactive')
    ...
    call hist_addfld1d (fname='PPOOL_TO_LIVECROOTP_STORAGE', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%ppool_to_livecrootp_storage, default='inactive')

    call hist_addfld1d (fname='PPOOL_TO_DEADCROOTP', units='gP/m^2/s', &
         avgflag='A', long_name='allocation to dead coarse root P', &
         ptr_pft=clm3%g%l%c%p%pphof%ppool_to_deadcrootp, default='inactive')
    ...
    call hist_addfld1d (fname='LIVESTEMP_STORAGE_TO_XFER', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%livestemp_storage_to_xfer, default='inactive')
    ...
    call hist_addfld1d (fname='DEADSTEMP_STORAGE_TO_XFER', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%deadstemp_storage_to_xfer, default='inactive')
    ...
    call hist_addfld1d (fname='LIVECROOTP_STORAGE_TO_XFER', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%livecrootp_storage_to_xfer, default='inactive')
    ...
    call hist_addfld1d (fname='DEADCROOTP_STORAGE_TO_XFER', units='gP/m^2/s', &
         ...
         ptr_pft=clm3%g%l%c%p%pphof%deadcrootp_storage_to_xfer, default='inactive')

    call hist_addfld1d (fname='LIVESTEMP_TO_DEADSTEMP', units='gP/m^2/s', &
         avgflag='A', long_name='live stem P turnover', &
         ptr_pft=clm3%g%l%c%p%pphof%livestemp_to_deadstemp, default='inactive')

    call hist_addfld1d (fname='LIVESTEMP_TO_RETRANSP', units='gP/m^2/s', &
         avgflag='A', long_name='live stem P to retranslocated P pool', &
         ptr_pft=clm3%g%l%c%p%pphof%livestemp_to_retransp, default='inactive')

    call hist_addfld1d (fname='LIVECROOTP_TO_DEADCROOTP', units='gP/m^2/s', &
         avgflag='A', long_name='live coarse root P turnover', &
         ptr_pft=clm3%g%l%c%p%pphof%livecrootp_to_deadcrootp, default='inactive')

    call hist_addfld1d (fname='LIVECROOTP_TO_RETRANSP', units='gP/m^2/s', &
         avgflag='A', long_name='live coarse root P to retranslocated P pool', &
         ptr_pft=clm3%g%l%c%p%pphof%livecrootp_to_retransp, default='inactive')

    call hist_addfld1d (fname='PDEPLOY', units='gP/m^2/s', &
         avgflag='A', long_name='total P deployed in new growth', &
         ptr_pft=clm3%g%l%c%p%pphof%pdeploy)

    call hist_addfld1d (fname='WOOD_HARVESTP', units='gP/m^2/s', &
         avgflag='A', long_name='wood harvest (to product pools)', &
         ptr_pft=clm3%g%l%c%p%pphof%wood_harvestp)

    call hist_addfld1d (fname='PFT_FIRE_PLOSS', units='gP/m^2/s', &
         avgflag='A', long_name='total pft-level fire P loss', &
         ptr_pft=clm3%g%l%c%p%pphof%pft_fire_ploss)

    !-------------------------------
    ! P flux variables - native to column (add phosphorus)
    !-------------------------------

    call hist_addfld1d (fname='PRIMP_TO_LABILEP', units='gP/m^2/s', &
         avgflag='A', long_name='PRIMARY MINERAL P TO LABILE P', &
         ptr_col=clm3%g%l%c%cphof%primp_to_labilep)

    call hist_addfld1d (fname='LABILEP_TO_SECONDP', units='gP/m^2/s', &
         avgflag='A', long_name='LABILE P TO SECONDARY MINERAL P', &
         ptr_col=clm3%g%l%c%cphof%labilep_to_secondp)

    call hist_addfld1d (fname='SECONDP_TO_LABILEP', units='gP/m^2/s', &
         avgflag='A', long_name='SECONDARY MINERAL P TO LABILE P', &
         ptr_col=clm3%g%l%c%cphof%secondp_to_labilep)

    call hist_addfld1d (fname='SECONDP_TO_OCCLP', units='gP/m^2/s', &
         avgflag='A', long_name='SECONDARY MINERAL P TO OCCLUDED P', &
         ptr_col=clm3%g%l%c%cphof%secondp_to_occlp)

    call hist_addfld1d (fname='M_LEAFP_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_leafp_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LEAFP_TO_LITR2P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P mortality to litter 2 P', &
         ptr_col=clm3%g%l%c%cphof%m_leafp_to_litr2p, default='inactive')

    call hist_addfld1d (fname='M_LEAFP_TO_LITR3P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P mortality to litter 3 P', &
         ptr_col=clm3%g%l%c%cphof%m_leafp_to_litr3p, default='inactive')

    call hist_addfld1d (fname='M_FROOTP_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_frootp_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_FROOTP_TO_LITR2P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P mortality to litter 2 P', &
         ptr_col=clm3%g%l%c%cphof%m_frootp_to_litr2p, default='inactive')

    call hist_addfld1d (fname='M_FROOTP_TO_LITR3P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P mortality to litter 3 P', &
         ptr_col=clm3%g%l%c%cphof%m_frootp_to_litr3p, default='inactive')

    call hist_addfld1d (fname='M_LEAFP_STORAGE_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P storage mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_leafp_storage_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_FROOTP_STORAGE_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P storage mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_frootp_storage_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LIVESTEMP_STORAGE_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='live stem P storage mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_livestemp_storage_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_DEADSTEMP_STORAGE_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='dead stem P storage mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_deadstemp_storage_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LIVECROOTP_STORAGE_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='live coarse root P storage mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_livecrootp_storage_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_DEADCROOTP_STORAGE_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='dead coarse root P storage mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_deadcrootp_storage_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LEAFP_XFER_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P transfer mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_leafp_xfer_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_FROOTP_XFER_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P transfer mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_frootp_xfer_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LIVESTEMP_XFER_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='live stem P transfer mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_livestemp_xfer_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_DEADSTEMP_XFER_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='dead stem P transfer mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_deadstemp_xfer_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LIVECROOTP_XFER_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='live coarse root P transfer mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_livecrootp_xfer_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_DEADCROOTP_XFER_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='dead coarse root P transfer mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_deadcrootp_xfer_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_LIVESTEMP_TO_CWDP', units='gP/m^2/s', &
         avgflag='A', long_name='live stem P mortality to coarse woody debris P', &
         ptr_col=clm3%g%l%c%cphof%m_livestemp_to_cwdp, default='inactive')

    call hist_addfld1d (fname='M_DEADSTEMP_TO_CWDP', units='gP/m^2/s', &
         avgflag='A', long_name='dead stem P mortality to coarse woody debris P', &
         ptr_col=clm3%g%l%c%cphof%m_deadstemp_to_cwdp, default='inactive')

    call hist_addfld1d (fname='M_LIVECROOTP_TO_CWDP', units='gP/m^2/s', &
         avgflag='A', long_name='live coarse root P mortality to coarse woody debris P', &
         ptr_col=clm3%g%l%c%cphof%m_livecrootp_to_cwdp, default='inactive')

    call hist_addfld1d (fname='M_DEADCROOTP_TO_CWDP', units='gP/m^2/s', &
         avgflag='A', long_name='dead coarse root P mortality to coarse woody debris P', &
         ptr_col=clm3%g%l%c%cphof%m_deadcrootp_to_cwdp, default='inactive')

    call hist_addfld1d (fname='M_RETRANSP_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='retranslocated P pool mortality to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%m_retransp_to_litr1p, default='inactive')

    call hist_addfld1d (fname='M_DEADSTEMP_TO_CWDP_FIRE', units='gP/m^2/s', &
         avgflag='A', long_name='dead stem P to coarse woody debris P by fire', &
         ptr_col=clm3%g%l%c%cphof%m_deadstemp_to_cwdp_fire, default='inactive')

    call hist_addfld1d (fname='M_DEADCROOTP_TO_CWDP_FIRE', units='gP/m^2/s', &
         avgflag='A', long_name='dead coarse root P to to woody debris P by fire', &
         ptr_col=clm3%g%l%c%cphof%m_deadcrootp_to_cwdp_fire, default='inactive')

    call hist_addfld1d (fname='M_LITR1P_TO_FIRE', units='gP/m^2/s', &
         avgflag='A', long_name='litter 1 P fire loss', &
         ptr_col=clm3%g%l%c%cphof%m_litr1p_to_fire, default='inactive')

    call hist_addfld1d (fname='M_LITR2P_TO_FIRE', units='gP/m^2/s', &
         avgflag='A', long_name='litter 2 P fire loss', &
         ptr_col=clm3%g%l%c%cphof%m_litr2p_to_fire, default='inactive')

    call hist_addfld1d (fname='M_LITR3P_TO_FIRE', units='gP/m^2/s', &
         avgflag='A', long_name='litter 3 P fire loss', &
         ptr_col=clm3%g%l%c%cphof%m_litr3p_to_fire, default='inactive')

    call hist_addfld1d (fname='M_CWDP_TO_FIRE', units='gP/m^2/s', &
         avgflag='A', long_name='coarse woody debris N fire loss', &
         ptr_col=clm3%g%l%c%cphof%m_cwdp_to_fire, default='inactive')

    call hist_addfld1d (fname='LEAFP_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P litterfall to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%leafp_to_litr1p)

    call hist_addfld1d (fname='LEAFP_TO_LITR2P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P litterfall to litter 2 P', &
         ptr_col=clm3%g%l%c%cphof%leafp_to_litr2p)

    call hist_addfld1d (fname='LEAFP_TO_LITR3P', units='gP/m^2/s', &
         avgflag='A', long_name='leaf P litterfall to litter 3 P', &
         ptr_col=clm3%g%l%c%cphof%leafp_to_litr3p)

    call hist_addfld1d (fname='FROOTP_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P litterfall to litter 1 P', &
         ptr_col=clm3%g%l%c%cphof%frootp_to_litr1p, default='inactive')

    call hist_addfld1d (fname='FROOTP_TO_LITR2P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P litterfall to litter 2 P', &
         ptr_col=clm3%g%l%c%cphof%frootp_to_litr2p, default='inactive')

    call hist_addfld1d (fname='FROOTP_TO_LITR3P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root P litterfall to litter 3 P ', &
         ptr_col=clm3%g%l%c%cphof%frootp_to_litr3p, default='inactive')

    call hist_addfld1d (fname='CWDP_TO_LITR2P', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of coarse woody debris N to litter 2 P', &
         ptr_col=clm3%g%l%c%cphof%cwdp_to_litr2p, default='inactive')

    call hist_addfld1d (fname='CWDP_TO_LITR3P', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of coarse woody debris N to litter 3 P', &
         ptr_col=clm3%g%l%c%cphof%cwdp_to_litr3p, default='inactive')

    call hist_addfld1d (fname='LITR1P_TO_SOIL1P', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of litter 1 P to SOM 1 P', &
         ptr_col=clm3%g%l%c%cphof%litr1p_to_soil1p, default='inactive')

    call hist_addfld1d (fname='SMINP_TO_SOIL1P_L1', units='gP/m^2/s', &
         avgflag='A', long_name='mineral P flux for decomp. of litter 1 to SOM 1', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_soil1p_l1, default='inactive')

    call hist_addfld1d (fname='LITR2P_TO_SOIL2P', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of litter 2 P to SOM 2 N', &
         ptr_col=clm3%g%l%c%cphof%litr2p_to_soil2p, default='inactive')

    call hist_addfld1d (fname='SMINP_TO_SOIL2P_L2', units='gP/m^2/s', &
         avgflag='A', long_name='mineral P flux for decomp. of litter 2 to SOM 2', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_soil2p_l2, default='inactive')

    call hist_addfld1d (fname='LITR3P_TO_SOIL3P', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of litter 3 P to SOM 3 N', &
         ptr_col=clm3%g%l%c%cphof%litr3p_to_soil3p, default='inactive')

    call hist_addfld1d (fname='SMINP_TO_SOIL3P_L3', units='gP/m^2/s', &
         avgflag='A', long_name='mineral P flux for decomp. of litter 3 to SOM 3', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_soil3p_l3, default='inactive')

    call hist_addfld1d (fname='SOIL1P_TO_SOIL2n', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of SOM 1 N to SOM 2 N', &
         ptr_col=clm3%g%l%c%cphof%soil1p_to_soil2p, default='inactive')

    call hist_addfld1d (fname='SMINP_TO_SOIL2P_S1', units='gP/m^2/s', &
         avgflag='A', long_name='mineral P flux for decomp. of SOM 1 to SOM 2', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_soil2p_s1, default='inactive')

    call hist_addfld1d (fname='SOIL2P_TO_SOIL3P', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of SOM 2 N to SOM 3 N', &
         ptr_col=clm3%g%l%c%cphof%soil2p_to_soil3p, default='inactive')

    call hist_addfld1d (fname='SMINP_TO_SOIL3P_S2', units='gP/m^2/s', &
         avgflag='A', long_name='mineral P flux for decomp. of SOM 2 to SOM 3', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_soil3p_s2, default='inactive')

    call hist_addfld1d (fname='SOIL3P_TO_SOIL4N', units='gP/m^2/s', &
         avgflag='A', long_name='decomp. of SOM 3 N to SOM 4 N', &
         ptr_col=clm3%g%l%c%cphof%soil3p_to_soil4p, default='inactive')

    call hist_addfld1d (fname='SMINP_TO_SOIL4N_S3', units='gP/m^2/s', &
         avgflag='A', long_name='mineral P flux for decomp. of SOM 3 to SOM 4', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_soil4p_s3, default='inactive')

    call hist_addfld1d (fname='SOIL4P_TO_SMINP', units='gP/m^2/s', &
         avgflag='A', long_name='P mineralization for decomp. of SOM 4', &
         ptr_col=clm3%g%l%c%cphof%soil4p_to_sminp, default='inactive')


    call hist_addfld1d (fname='SMINP_LEACHED', units='gP/m^2/s', &
         avgflag='A', long_name='soil mineral P pool loss to leaching', &
         ptr_col=clm3%g%l%c%cphof%sminp_leached)

    call hist_addfld1d (fname='POTENTIAL_IMMOB_P', units='gP/m^2/s', &
         avgflag='A', long_name='potential P immobilization', &
         ptr_col=clm3%g%l%c%cphof%potential_immob_p)

    call hist_addfld1d (fname='ACTUAL_IMMOB_P', units='gP/m^2/s', &
         avgflag='A', long_name='actual P immobilization', &
         ptr_col=clm3%g%l%c%cphof%actual_immob_p)

    call hist_addfld1d (fname='SMINP_TO_PLANT', units='gP/m^2/s', &
         avgflag='A', long_name='plant uptake of soil mineral P', &
         ptr_col=clm3%g%l%c%cphof%sminp_to_plant)

    call hist_addfld1d (fname='SUPPLEMENT_TO_SMINP', units='gP/m^2/s', &
         avgflag='A', long_name='supplemental P supply', &
         ptr_col=clm3%g%l%c%cphof%supplement_to_sminp)

    call hist_addfld1d (fname='GROSS_PMIN', units='gP/m^2/s', &
         avgflag='A', long_name='gross rate of P mineralization', &
         ptr_col=clm3%g%l%c%cphof%gross_pmin)

    call hist_addfld1d (fname='NET_PMIN', units='gP/m^2/s', &
         avgflag='A', long_name='net rate of P mineralization', &
         ptr_col=clm3%g%l%c%cphof%net_pmin)

    call hist_addfld1d (fname='BIOCHEM_PMIN', units='gP/m^2/s', &
         avgflag='A', long_name='rate of biochemical P mineralization', &
         ptr_col=clm3%g%l%c%cphof%biochem_pmin)

    call hist_addfld1d (fname='COL_FIRE_PLOSS', units='gP/m^2/s', &
         avgflag='A', long_name='total column-level fire P loss', &
         ptr_col=clm3%g%l%c%cphof%col_fire_ploss)

    call hist_addfld1d (fname='DWT_SEEDP_TO_LEAF', units='gP/m^2/s', &
         avgflag='A', long_name='seed source to PFT-level leaf', &
         ptr_col=clm3%g%l%c%cphof%dwt_seedp_to_leaf)

    call hist_addfld1d (fname='DWT_SEEDP_TO_DEADSTEM', units='gP/m^2/s', &
         avgflag='A', long_name='seed source to PFT-level deadstem', &
         ptr_col=clm3%g%l%c%cphof%dwt_seedp_to_deadstem)

    call hist_addfld1d (fname='DWT_CONV_PFLUX', units='gP/m^2/s', &
         avgflag='A', long_name='conversion P flux (immediate loss to atm)', &
         ptr_col=clm3%g%l%c%cphof%dwt_conv_pflux)

    call hist_addfld1d (fname='DWT_PROD10P_GAIN', units='gP/m^2/s', &
         avgflag='A', long_name='addition to 10-yr wood product pool', &
         ptr_col=clm3%g%l%c%cphof%dwt_prod10p_gain)

    call hist_addfld1d (fname='PROD10P_LOSS', units='gP/m^2/s', &
         avgflag='A', long_name='loss from 10-yr wood product pool', &
         ptr_col=clm3%g%l%c%cphof%prod10p_loss)

    call hist_addfld1d (fname='DWT_PROD100P_GAIN', units='gP/m^2/s', &
         avgflag='A', long_name='addition to 100-yr wood product pool', &
         ptr_col=clm3%g%l%c%cphof%dwt_prod100p_gain)

    call hist_addfld1d (fname='PROD100P_LOSS', units='gP/m^2/s', &
         avgflag='A', long_name='loss from 100-yr wood product pool', &
         ptr_col=clm3%g%l%c%cphof%prod100p_loss)

    call hist_addfld1d (fname='PRODUCT_PLOSS', units='gP/m^2/s', &
         avgflag='A', long_name='total P loss from wood product pools', &
         ptr_col=clm3%g%l%c%cphof%product_ploss)

    call hist_addfld1d (fname='DWT_FROOTP_TO_LITR1P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root to litter due to landcover change', &
         ptr_col=clm3%g%l%c%cphof%dwt_frootp_to_litr1p, default='inactive')

    call hist_addfld1d (fname='DWT_FROOTP_TO_LITR2P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root to litter due to landcover change', &
         ptr_col=clm3%g%l%c%cphof%dwt_frootp_to_litr2p, default='inactive')

    call hist_addfld1d (fname='DWT_FROOTP_TO_LITR3P', units='gP/m^2/s', &
         avgflag='A', long_name='fine root to litter due to landcover change', &
         ptr_col=clm3%g%l%c%cphof%dwt_frootp_to_litr3p, default='inactive')

    call hist_addfld1d (fname='DWT_LIVECROOTP_TO_CWDP', units='gP/m^2/s', &
         avgflag='A', long_name='live coarse root to CWD due to landcover change', &
         ptr_col=clm3%g%l%c%cphof%dwt_livecrootp_to_cwdp, default='inactive')

    call hist_addfld1d (fname='DWT_DEADCROOTP_TO_CWDP', units='gP/m^2/s', &
         avgflag='A', long_name='dead coarse root to CWD due to landcover change', &
         ptr_col=clm3%g%l%c%cphof%dwt_deadcrootp_to_cwdp, default='inactive')

    call hist_addfld1d (fname='DWT_PLOSS', units='gP/m^2/s', &
         avgflag='A', long_name='total phosphorus loss from landcover conversion', &
         ptr_col=clm3%g%l%c%cphof%dwt_ploss)
...
!
    call hist_addfld1d (fname='ANNSUM_NPP', units='gC/m^2/yr', &
         ...
         ptr_pft=clm3%g%l%c%p%pepv%annsum_npp)
