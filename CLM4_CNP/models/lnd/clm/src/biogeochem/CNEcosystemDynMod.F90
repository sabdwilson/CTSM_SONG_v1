...
! !USES:
    ...
    use PDynamicsMod         , only: PWeathering,PAdsorption,PDesorption,POcclusion,PBiochemMin,PLeaching
    ...
    use CNBalanceCheckMod    , only: CBalanceCheck, NBalanceCheck,PBalanceCheck
    use CNPrecisionControlMod, only: CNPrecisionControl
    use CNVegStructUpdateMod , only: CNVegStructUpdate
    use CNAnnualUpdateMod    , only: CNAnnualUpdate
    use CNSummaryMod         , only: CSummary, NSummary,PSummary
#if (defined C13)
...
!      !add phosphorus
       ...
       call PBiochemMin(num_soilc, filter_soilc)
       ...
       call PLeaching(lbc, ubc, num_soilc, filter_soilc)
       ...
       call PStateUpdate3(num_soilc, filter_soilc, num_soilp, filter_soilp)
...
!       call CNAnnualUpdate(num_soilc, filter_soilc, num_soilp, filter_soilp)
       ...
       call PSummary(num_soilc, filter_soilc, num_soilp, filter_soilp)
