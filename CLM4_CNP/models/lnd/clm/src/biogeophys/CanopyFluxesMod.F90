...
!
     ...
     real(r8) :: f3      ! generic temperature response (statement function)
     real(r8) :: slope
     real(r8) :: y1
     real(r8) :: y
     real(r8) :: tc_thresh
...
#if (defined C14)
           ! 11/08/12: JFM and DMR - add C14 fractionation term
           alphapsn(p) = 1._r8 + (((c3psn(ivt(p)) * (2.0*4.4_r8 + (2.0*22.6_r8*(ci(p)/co2(p))))) + &
                         ((1._r8 - c3psn(ivt(p))) * 2.0*4.4_r8))/1000._r8)
#endif
           !alphapsn(p) = 1._r8
