...
contains
  ...
  subroutine addglobal (ncid, cmdline)
    ...
    character(len=256):: version = &
         "$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/trunk_tags/clm4_0_38/models/lnd/clm/tools/interpinic/src/interpinic.F90 $"
    character(len=256)  :: revision_id = "$Id: interpinic.F90 30743 2011-09-27 21:21:12Z erik $"
