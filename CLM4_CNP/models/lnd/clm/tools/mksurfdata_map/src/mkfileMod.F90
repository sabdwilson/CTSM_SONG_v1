...
!-----------------------------------------------------------------------
    ...
    str = &
'$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/trunk_tags/clm4_0_38/models/lnd/clm/tools/mksurfdata_map/src/mkfileMod.F90 $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
         'Version', len_trim(str), trim(str)), subname)

    str = '$Id: mkfileMod.F90 33915 2012-01-19 18:28:11Z erik $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
