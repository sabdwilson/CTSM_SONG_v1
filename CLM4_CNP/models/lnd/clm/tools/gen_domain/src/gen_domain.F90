...
!-------------------------------------------------------------------------------
  ...
  if (fmap == ' ' .or. fn1_out == ' ' .or. fn2_out== ' ') then
...
!===========================================================================
  ...
  subroutine write_file(fid, fmap, units_xc, units_yc, n, ni, nj, &
    ...
    real(r8),parameter    :: pi  = 3.14159265358979323846
    character(*),parameter:: version = 'SVN $Id: gen_domain.F90 33817 2012-01-17 18:33:43Z erik $'
    ...
    str = ' $URL: https://svn-ccsm-models.cgd.ucar.edu/tools/mapping/gen_domain/trunk_tags/gen_domain_120117/src/gen_domain.F90 $'
...
!===========================================================================
  ...
  subroutine sys_getenv(name, val, rcode)
    ...
    character(len=CL)   :: tmpval  ! temporary env var value
...
#if (!defined CRAY && !defined AIX && !defined OSF1 && !defined SUNOS && !defined LINUX && !defined NEC_SX && !defined UNICOSMP && !defined __G95__)
