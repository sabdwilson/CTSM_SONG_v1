...
! Calendar is hard-coded.  Use ESMF library if more flexibility is needed.  
      ...
      if ( calkindflag%caltype  /= ESMF_CALKIND_NOLEAP%caltype ) then
         ...
         write(6,*) 'This implementation only allows ESMF_CALKIND_NOLEAP'
         write(6,*) 'calender type set to     = ', calkindflag%caltype
         write(6,*) 'NO_LEAP calendar type is = ', ESMF_CALKIND_NOLEAP%caltype
         return
      end if
      ...
      if ( calkindflag%caltype  /= ESMF_CALKIND_GREGORIAN%caltype ) then
         write(6,*) 'Not a valid calendar type for this implementation'
         write(6,*) 'This implementation only allows ESMF_CALKIND_GREGORIAN'
         write(6,*) 'calender type set to     = ', calkindflag%caltype
         write(6,*) 'GREGORIAN calendar type is = ', ESMF_CALKIND_GREGORIAN%caltype
         return
      end if
