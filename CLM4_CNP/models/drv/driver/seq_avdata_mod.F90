!===============================================================================
! SVN $Id: seq_avdata_mod.F90 29302 2011-07-19 19:18:10Z tcraig $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/trunk_tags/drvseq4_0_04/driver/seq_avdata_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
! !PUBLIC DATA MEMBERS:
   ...
   type (seq_cdata) :: cdata_rr(num_inst_lnd)
   ...
   type(mct_gGrid) :: dom_rr(num_inst_lnd)      ! runoff domain
   ...
   type(mct_aVect) :: r2x_rr(num_inst_lnd)    ! Rof export, rof grid, lnd pes - allocated in lnd gc

   type(mct_aVect) :: r2x_rx(num_inst_lnd)    ! Rof export, rof grid, cpl pes - allocated in driver
   type(mct_accum) :: r2xacc_rx(num_inst_lnd) ! Rof export, rof grid, cpl pes - allocated in driver
   type(mct_aVect) :: r2x_ox(num_inst_lnd)    ! Rof export, ocn grid, cpl pes - allocated in driver
   ...
   type(mct_accum) :: x2oacc_ox(num_inst_ocn) ! Ocn import, ocn grid, cpl pes - allocated in driver
