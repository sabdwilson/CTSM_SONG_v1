...
# based on environment variable values set in the env_mach_pes.xml file
#-------------------------------------------------------------------------------
...
$psbrsflag    = -1; # pbs resources option for NAS (e.g. NASA pleiades)
...
@ninst  = (          1,  $NINST_ATM,  $NINST_LND,  $NINST_ICE,  $NINST_OCN,  $NINST_GLC);
