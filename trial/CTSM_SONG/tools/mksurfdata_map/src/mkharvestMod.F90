...
! !PUBLIC DATA MEMBERS:
  ...
  integer, private, parameter :: numharv =  6  ! number of harvest and grazing fields; revised by Yang Song
...
! !PRIVATE DATA MEMBERS:
  ...
  character(len=harlen), parameter  :: harvest_fieldnames(numharv) = (/ &
                                                        ...
                                                        'HARVEST_SH2            ',  &
                                                        'HARVEST_SH3            ',  &
                                                        'GRAZING                '/)!,  & revised by Yang Song changing dimension from 9 to 6
                                                        !'FERTNITRO_CFT          ',  &
  ...
  character(len=harlen), parameter  :: harvest_const_fieldnames(numharv) = (/ &
                                                        ...
                                                        'CONST_HARVEST_SH2      ',  &
                                                        'CONST_HARVEST_SH3      ',  &
                                                        'CONST_GRAZING          '/)!,  & revised by Yang Song changing dimension from 9 to 6
                                                        !'CONST_FERTNITRO_CFT    ',  &
                                                        !'UNREPRESENTED_PFT_LULCC',  &
                                                        !'UNREPRESENTED_CFT_LULCC'   &
                                                      !/)
...
!-----------------------------------------------------------------------
  ...
  write(6,*) "oride_harv=", oride_harv(1:numharv)
