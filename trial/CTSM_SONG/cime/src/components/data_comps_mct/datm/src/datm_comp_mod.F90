  ...
  subroutine datm_comp_run(EClock, x2a, a2x, &
    ...
    case('CLMNCEP')
       ...
       do n = 1,lsize
          ...
          write(300007,*)CurrentYMD,CurrentTOD,lsize,n,a2x%rAttr(kptem,n),a2x%rAttr(ksc,n),a2x%rAttr(ksl,n),a2x%rAttr(krc,n),a2x%rAttr(krl,n),&
          a2x%rAttr(kshum,n),a2x%rAttr(kswndr,n),a2x%rAttr(kswvdr,n),a2x%rAttr(kswndf,n),a2x%rAttr(kswvdf,n),a2x%rAttr(klwdn,n),a2x%rAttr(ku,n),&
          a2x%rAttr(kv,n)                
       enddo
