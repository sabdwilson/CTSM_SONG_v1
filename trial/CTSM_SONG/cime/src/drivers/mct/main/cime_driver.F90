program cime_driver
  ...
  write(6,*) "ESMF_Initialize_time",ESMF_Initialize_time,beg_count,end_count,irtc_rate
  !--------------------------------------------------------------------------
  ...
  write(6,*) "cime_pre_init2_time",cime_pre_init2_time,beg_count,end_count,irtc_rate
  !--------------------------------------------------------------------------
