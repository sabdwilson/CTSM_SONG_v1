...
contains
  ...
  subroutine CBalanceCheck(this, bounds, num_soilc, filter_soilc, &
    ...
    integer  ::  kda
    integer  ::  mcsec
    real(r8) :: biochar_c(num_soilc)
    real(r8) :: biochar_c_input(num_soilc)
    !-----------------------------------------------------------------------
  ...
  subroutine NBalanceCheck(this, bounds, num_soilc, filter_soilc, &
    ...
    integer :: kda
    integer :: mcsec
    real(r8):: biochar_n(num_soilc)
    real(r8):: biochar_cn(num_soilc) ! total biochar cn ratio of both pools
