module clm_varctl
  ...
  logical, public :: use_biochar         = .false. ! Sabrina Mod
  integer, public :: Biochar_Tyear       = 0       ! Sabrina Mod 
  integer, public :: init_bio_yr         = 0
  ...
  logical, public :: use_fert_fix        = .false. ! Sabrina Mod
