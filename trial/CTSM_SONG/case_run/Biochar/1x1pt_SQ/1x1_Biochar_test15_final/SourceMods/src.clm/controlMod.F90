...
contains
  ...
  subroutine control_init(dtime)
    ...
    namelist /clm_inparm/ &
         ...
         use_nguardrail, use_fert_fix, use_biochar, Biochar_Tyear,init_bio_yr !Sabrina Mod
  ...
  subroutine control_spmd()
    ...
    call mpi_bcast (use_biochar, 1, MPI_LOGICAL, 0, mpicom, ier) ! Sabrina Mod
    call mpi_bcast (Biochar_Tyear, 1, MPI_INTEGER, 0, mpicom, ier) ! sabrina 
    call mpi_bcast (init_bio_yr, 1, MPI_INTEGER, 0, mpicom, ier)
    ...
    call mpi_bcast (use_fert_fix, 1, MPI_LOGICAL, 0, mpicom, ier) ! Sabrina Mod
  ...
  subroutine control_print ()
    ...
    write(iulog,*) '    use_biochar = ', use_biochar ! Sabrina Mod
    write(iulog,*) '    Biochar_Tyear = ', Biochar_Tyear
    write(iulog,*) '    init_bio_yr = ', init_bio_yr
    ...
    write(iulog,*) '    use_fert_fix = ', use_fert_fix ! Sabrina Mod
