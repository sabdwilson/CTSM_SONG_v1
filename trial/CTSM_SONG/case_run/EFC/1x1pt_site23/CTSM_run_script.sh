...
export Run_folder="1x1pt_site23"
...
export Surface_data_spinup="${Surface_data}/site23/1x1pt_site23"
export Surface_data_final="${Surface_data}/site23/1x1pt_site23"
export Surface_data_hist="${Surface_data}/site23/1x1pt_site23"
export fsurf_data="surfdata_1x1pt_site23_hist_78pfts_CMIP6_simyr2000_c240517.nc"
export fatmdomain="domain.lnd.1x1pt_site23_navy.240517.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site23"
...
export DATM_CLMNCEP_YR_END_spinup=2010
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2009 2010 2010",
