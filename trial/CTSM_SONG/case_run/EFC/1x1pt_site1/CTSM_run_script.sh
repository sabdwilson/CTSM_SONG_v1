...
export Surface_data_spinup="${Surface_data}/site1/1x1pt_site1"
export Surface_data_final="${Surface_data}/site1/1x1pt_site1"
export Surface_data_hist="${Surface_data}/site1/1x1pt_site1"
export fsurf_data="surfdata_1x1pt_site1_hist_78pfts_CMIP6_simyr2000_c240518.nc"
export fatmdomain="domain.lnd.1x1pt_site1_navy.240518.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site1"
