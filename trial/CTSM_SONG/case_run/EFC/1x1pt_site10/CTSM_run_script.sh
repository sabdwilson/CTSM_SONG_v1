...
export Run_folder="1x1pt_site10"
...
export Surface_data_spinup="${Surface_data}/site10/1x1pt_site10"
export Surface_data_final="${Surface_data}/site10/1x1pt_site10"
export Surface_data_hist="${Surface_data}/site10/1x1pt_site10"
export fsurf_data="surfdata_1x1pt_site10_hist_78pfts_CMIP6_simyr2000_c240610.nc"
export fatmdomain="domain.lnd.1x1pt_site10_navy.240610.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site10"
...
export DATM_CLMNCEP_YR_END_spinup=2013
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2012 2013 2013",
