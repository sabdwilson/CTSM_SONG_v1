...
export CASE_NAME="control"
export Project_folder="EFC"
export Run_folder="1x1pt_site30"
...
export Surface_data_spinup="${Surface_data}/site30/1x1pt_site30"
export Surface_data_final="${Surface_data}/site30/1x1pt_site30"
export Surface_data_hist="${Surface_data}/site30/1x1pt_site30"
export fsurf_data="surfdata_1x1pt_site30_hist_78pfts_CMIP6_simyr2000_c240610.nc"
export fatmdomain="domain.lnd.1x1pt_site30_navy.240610.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site30"
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2011 2012 2012",
