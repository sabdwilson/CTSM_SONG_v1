...
export Surface_data_spinup="${Surface_data}/site8/1x1pt_site8"
export Surface_data_final="${Surface_data}/site8/1x1pt_site8"
export Surface_data_hist="${Surface_data}/site8/1x1pt_site8"
export fsurf_data="surfdata_1x1pt_site8_hist_78pfts_CMIP6_simyr2000_c240516.nc"
export fatmdomain="domain.lnd.1x1pt_site8_navy.240516.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site8"
...
export DATM_CLMNCEP_YR_END_spinup=2008
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2007 2008 2008",
