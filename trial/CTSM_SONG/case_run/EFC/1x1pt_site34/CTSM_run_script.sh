...
case_revised_src=0 #1-copy the case code from identified folder, need to give the folder pathway
case_running_spinup=(0 0 0)
case_running_final=(0 0 0)
case_running_hist=(1 1 1)
...
export CASE_NAME="control2"
export Project_folder="EFC"
export Run_folder="1x1pt_site34"
...
export Surface_data_spinup="${Surface_data}/site34/1x1pt_site34"
export Surface_data_final="${Surface_data}/site34/1x1pt_site34"
export Surface_data_hist="${Surface_data}/site34/1x1pt_site34"
export fsurf_data="surfdata_1x1pt_site34_hist_78pfts_CMIP6_simyr2000_c240518.nc"
export fatmdomain="domain.lnd.1x1pt_site34_navy.240518.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site34"
...
export DATM_CLMNCEP_YR_START_hist=2011
export DATM_CLMNCEP_YR_END_hist=2012
export DATM_CLMNCEP_YR_ALIGN_hist=2011
...
hist_fincl1 = 'GPP:A','TWS:A','TOTLITC:A','TSOI:A'
...
cat >> user_nl_clm <<EOF
hist_empty_htapes = .true.
hist_fincl1 = 'NPP:A','TSOI:A','H2OSOI:A'
hist_dov2xy = .true.
hist_type1d_pertape = ' '
hist_nhtfrq = -24
hist_mfilt  = 100000
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2010 2012 2012",
