...
export Run_folder="1x1pt_site26"
...
export Surface_data_spinup="${Surface_data}/site26/1x1pt_site26"
export Surface_data_final="${Surface_data}/site26/1x1pt_site26"
export Surface_data_hist="${Surface_data}/site26/1x1pt_site26"
export fsurf_data="surfdata_1x1pt_site26_hist_78pfts_CMIP6_simyr2000_c240517.nc"
export fatmdomain="domain.lnd.1x1pt_site26_navy.240517.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site26"
...
export DATM_CLMNCEP_YR_END_spinup=2017
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2016 2017 2017",
