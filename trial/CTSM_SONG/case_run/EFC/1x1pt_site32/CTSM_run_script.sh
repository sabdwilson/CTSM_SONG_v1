...
export Run_folder="1x1pt_site32"
...
export Surface_data_spinup="${Surface_data}/site32/1x1pt_site32"
export Surface_data_final="${Surface_data}/site32/1x1pt_site32"
export Surface_data_hist="${Surface_data}/site32/1x1pt_site32"
export fsurf_data="surfdata_1x1pt_site32_hist_78pfts_CMIP6_simyr2000_c240518.nc"
export fatmdomain="domain.lnd.1x1pt_site32_navy.240518.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site32"
...
export DATM_CLMNCEP_YR_END_spinup=2014
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2010 2014 2014",
