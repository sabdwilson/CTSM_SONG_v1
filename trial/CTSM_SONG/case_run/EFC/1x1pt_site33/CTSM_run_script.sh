...
export Run_folder="1x1pt_site33"
...
export Surface_data_spinup="${Surface_data}/site33/1x1pt_site33"
export Surface_data_final="${Surface_data}/site33/1x1pt_site33"
export Surface_data_hist="${Surface_data}/site33/1x1pt_site33"
export fsurf_data="surfdata_1x1pt_site33_hist_78pfts_CMIP6_simyr2000_c240610.nc"
export fatmdomain="domain.lnd.1x1pt_site33_navy.240610.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site33"
...
export DATM_CLMNCEP_YR_END_spinup=2015
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2014 2015 2015",
