...
export Run_folder="1x1pt_site13"
...
export Surface_data_spinup="${Surface_data}/site13/1x1pt_site13"
export Surface_data_final="${Surface_data}/site13/1x1pt_site13"
export Surface_data_hist="${Surface_data}/site13/1x1pt_site13"
export fsurf_data="surfdata_1x1pt_site13_hist_78pfts_CMIP6_simyr2000_c240516.nc"
export fatmdomain="domain.lnd.1x1pt_site13_navy.240516.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site13"
...
export DATM_CLMNCEP_YR_END_spinup=2011
...
export DATM_CLMNCEP_YR_END_hist=2011
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2010 2011 2011",
