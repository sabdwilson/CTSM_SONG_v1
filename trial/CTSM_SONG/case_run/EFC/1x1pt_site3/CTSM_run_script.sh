...
export Surface_data_spinup="${Surface_data}/site3/1x1pt_site3"
export Surface_data_final="${Surface_data}/site3/1x1pt_site3"
export Surface_data_hist="${Surface_data}/site3/1x1pt_site3"
export fsurf_data="surfdata_1x1pt_site3_hist_78pfts_CMIP6_simyr2000_c240518.nc"
export fatmdomain="domain.lnd.1x1pt_site3_navy.240518.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site3"
...
export DATM_CLMNCEP_YR_END_spinup=2023
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2022 2023 2023",
