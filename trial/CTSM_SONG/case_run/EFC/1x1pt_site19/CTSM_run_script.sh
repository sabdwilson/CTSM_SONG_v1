...
export Run_folder="1x1pt_site19"
...
export Surface_data_spinup="${Surface_data}/site19/1x1pt_site19"
export Surface_data_final="${Surface_data}/site19/1x1pt_site19"
export Surface_data_hist="${Surface_data}/site19/1x1pt_site19"
export fsurf_data="surfdata_1x1pt_site19_hist_78pfts_CMIP6_simyr2000_c240610.nc"
export fatmdomain="domain.lnd.1x1pt_site19_navy.240610.nc"
export Forcing="/home/u8/sdwilson/data/EFC/site19"
...
export DATM_CLMNCEP_YR_END_spinup=2009
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2008 2009 2009",
