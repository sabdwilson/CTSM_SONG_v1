...
contains
  ...
  subroutine restFile_write( bounds, file, writing_finidat_interp_dest_file, rdate, noptr)
    ...
    write(40007,*) "RESTART_DEFINE: clm_instRest_before"
    ...
    write(40007,*) "RESTART_DEFINE: clm_instRest_after"
    call shr_sys_flush(40007)
    ...
    write(40007,*) "RESTART_WRITE: clm_instRest_before"
    call shr_sys_flush(40007)
    call clm_instRest(bounds, ncid, flag='write', &
         writing_finidat_interp_dest_file=writing_finidat_interp_dest_file)
    write(40007,*) "RESTART_WRITE: clm_instRest_after"
    call shr_sys_flush(40007)
