...
export Surface_data_spinup="${Surface_data}/CLBJ/1x1pt_CLBJ"
export Surface_data_final="${Surface_data}/CLBJ/1x1pt_CLBJ"
export Surface_data_hist="${Surface_data}/CLBJ/1x1pt_CLBJ"
export fsurf_data="surfdata_1x1pt_CLBJ_hist_78pfts_CMIP6_simyr2000_c241128.nc"
export fatmdomain="domain.lnd.1x1pt_CLBJ_navy.241128.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/CLBJ"
