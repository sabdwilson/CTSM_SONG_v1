...
export Surface_data_spinup="${Surface_data}/SCBI/1x1pt_SCBI"
export Surface_data_final="${Surface_data}/SCBI/1x1pt_SCBI"
export Surface_data_hist="${Surface_data}/SCBI/1x1pt_SCBI"
export fsurf_data="surfdata_1x1pt_SCBI_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_SCBI_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/SCBI"
