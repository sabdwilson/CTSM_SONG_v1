...
export Surface_data_spinup="${Surface_data}/UNDE/1x1pt_UNDE"
export Surface_data_final="${Surface_data}/UNDE/1x1pt_UNDE"
export Surface_data_hist="${Surface_data}/UNDE/1x1pt_UNDE"
export fsurf_data="surfdata_unde_20perc.nc"
export fatmdomain="domain.lnd.1x1pt_UNDE_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/UNDE"
...
export DATM_CLMNCEP_YR_END_hist=2020
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2018 2018 2020",
