...
export Surface_data_spinup="${Surface_data}/BLAN/1x1pt_BLAN"
export Surface_data_final="${Surface_data}/BLAN/1x1pt_BLAN"
export Surface_data_hist="${Surface_data}/BLAN/1x1pt_BLAN"
export fsurf_data="surfdata_1x1pt_BLAN_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_BLAN_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/BLAN"
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2022 2022 2022",
