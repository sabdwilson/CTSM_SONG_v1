...
export Surface_data_spinup="${Surface_data}/OSBS/1x1pt_OSBS"
export Surface_data_final="${Surface_data}/OSBS/1x1pt_OSBS"
export Surface_data_hist="${Surface_data}/OSBS/1x1pt_OSBS"
export fsurf_data="surfdata_1x1pt_OSBS_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_OSBS_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/OSBS"
...
export DATM_CLMNCEP_YR_END_hist=2019
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2018 2018 2019",
