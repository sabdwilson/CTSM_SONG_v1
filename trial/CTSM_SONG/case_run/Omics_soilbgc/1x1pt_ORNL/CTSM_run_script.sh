...
export Surface_data_spinup="${Surface_data}/ORNL/1x1pt_ORNL"
export Surface_data_final="${Surface_data}/ORNL/1x1pt_ORNL"
export Surface_data_hist="${Surface_data}/ORNL/1x1pt_ORNL"
export fsurf_data="surfdata_1x1pt_ORNL_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_ORNL_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/ORNL"
...
export DATM_CLMNCEP_YR_ALIGN_hist=2020
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2020 2020 2021",
