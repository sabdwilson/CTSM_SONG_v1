...
export Surface_data_spinup="${Surface_data}/TREE/1x1pt_TREE"
export Surface_data_final="${Surface_data}/TREE/1x1pt_TREE"
export Surface_data_hist="${Surface_data}/TREE/1x1pt_TREE"
export fsurf_data="surfdata_1x1pt_TREE_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_TREE_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/TREE"
