...
export Surface_data_spinup="${Surface_data}/UKFS/1x1pt_UKFS"
export Surface_data_final="${Surface_data}/UKFS/1x1pt_UKFS"
export Surface_data_hist="${Surface_data}/UKFS/1x1pt_UKFS"
export fsurf_data="surfdata_1x1pt_UKFS_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_UKFS_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/UKFS"
