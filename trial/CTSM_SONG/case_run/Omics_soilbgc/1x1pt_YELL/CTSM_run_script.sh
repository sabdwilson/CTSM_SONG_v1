...
export CASE_NAME="test_steadyst"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_YELL"
...
export Surface_data_spinup="${Surface_data}/YELL/1x1pt_YELL"
export Surface_data_final="${Surface_data}/YELL/1x1pt_YELL"
export Surface_data_hist="${Surface_data}/YELL/1x1pt_YELL"
export fsurf_data="surfdata_1x1pt_YELL_hist_78pfts_CMIP6_simyr2000_c240904.nc"
export fatmdomain="domain.lnd.1x1pt_YELL_navy.240904.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/YELL"
