...
export Surface_data_spinup="${Surface_data}/HARV/1x1pt_HARV"
export Surface_data_final="${Surface_data}/HARV/1x1pt_HARV"
export Surface_data_hist="${Surface_data}/HARV/1x1pt_HARV"
export fsurf_data="surfdata_1x1pt_HARV_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_HARV_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/HARV"
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2021 2021 2023",
