...
!      end if
      ...
      do j = 1, nlevgrnd
         do fc = 1, num_hydrologyc
            ...
            !Tianyi Hu changed the lower bound !
            !s_node = max(h2osoi_vol(c,j)/watsat(c,j), 0.01_r8)
            s_node = max(h2osoi_vol(c,j)/watsat(c,j), 0.04_r8)
            ! ********************************* !
