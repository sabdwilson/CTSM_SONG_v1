...
export CASE_NAME="control4"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_TEAK"
...
then
	export CASE_SRC="${CTSM_folder}/case_run/${Project_folder}/${Run_foler}/control_hist/SourceMods"
...
export Surface_data_spinup="${Surface_data}/TEAK/1x1pt_TEAK"
export Surface_data_final="${Surface_data}/TEAK/1x1pt_TEAK"
export Surface_data_hist="${Surface_data}/TEAK/1x1pt_TEAK"
export fsurf_data="surfdata_1x1pt_TEAK_hist_78pfts_CMIP6_simyr2000_c240904.nc"
export fatmdomain="domain.lnd.1x1pt_TEAK_navy.240605.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/TEAK"
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2019 2019 2021",
