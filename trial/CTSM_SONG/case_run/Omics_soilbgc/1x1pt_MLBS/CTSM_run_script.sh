...
export CASE_NAME="test3"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_MLBS"
...
export Surface_data_spinup="${Surface_data}/MLBS/1x1pt_MLBS"
export Surface_data_final="${Surface_data}/MLBS/1x1pt_MLBS"
export Surface_data_hist="${Surface_data}/MLBS/1x1pt_MLBS"
export fsurf_data="surfdata_mlbs_20perc.nc"
export fatmdomain="domain.lnd.1x1pt_MLBS_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/MLBS"
