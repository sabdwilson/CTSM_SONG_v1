...
export CASE_NAME="control7"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_WOOD"
...
export Surface_data_spinup="${Surface_data}/WOOD/1x1pt_WOOD"
export Surface_data_final="${Surface_data}/WOOD/1x1pt_WOOD"
export Surface_data_hist="${Surface_data}/WOOD/1x1pt_WOOD"
export fsurif_data="surfdata_1x1pt_WOOD_hist_78pfts_CMIP6_simyr2000_c241110.nc"
export fatmdomain="domain.lnd.1x1pt_WOOD_navy.240605.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/WOOD"
