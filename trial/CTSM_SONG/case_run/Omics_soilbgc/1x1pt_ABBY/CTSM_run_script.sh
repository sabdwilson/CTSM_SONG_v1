...
export Surface_data_spinup="${Surface_data}/ABBY/1x1pt_ABBY"
export Surface_data_final="${Surface_data}/ABBY/1x1pt_ABBY"
export Surface_data_hist="${Surface_data}/ABBY/1x1pt_ABBY"
export fsurf_data="surfdata_1x1pt_ABBY_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_ABBY_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/ABBY"
