...
export CASE_NAME="test_pft1"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_KNOZ"
...
export Surface_data_spinup="${Surface_data}/KNOZ/1x1pt_KNOZ"
export Surface_data_final="${Surface_data}/KNOZ/1x1pt_KNOZ"
export Surface_data_hist="${Surface_data}/KNOZ/1x1pt_KNOZ"
export fsurf_data="surfdata_KNOZ_20perc.nc"
export fatmdomain="domain.lnd.1x1pt_KNOZ_navy.240904.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/KNOZ"
...
hist_fincl1 = 'GPP:A','TSOI:A','H2OSOI:A','SR:A','TOTSOMC:A',
	      'TOTSOMN:A','NPP:A'
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2018 2018 2022",
