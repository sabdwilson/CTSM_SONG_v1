...
export Surface_data_spinup="${Surface_data}/GUAN/1x1pt_GUAN"
export Surface_data_final="${Surface_data}/GUAN/1x1pt_GUAN"
export Surface_data_hist="${Surface_data}/GUAN/1x1pt_GUAN"
export fsurf_data="surfdata_0.9x1.25_hist_78pfts_CMIP6_simyr2000_GUAN_c221014.nc"
export fatmdomain="domain.lnd.1x1pt_GUAN_navy.240904.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/GUAN"
