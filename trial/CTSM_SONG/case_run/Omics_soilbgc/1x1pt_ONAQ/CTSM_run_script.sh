...
export Surface_data_spinup="${Surface_data}/ONAQ/1x1pt_ONAQ"
export Surface_data_final="${Surface_data}/ONAQ/1x1pt_ONAQ"
export Surface_data_hist="${Surface_data}/ONAQ/1x1pt_ONAQ"
export fsurf_data="surfdata_1x1pt_ONAQ_hist_78pfts_CMIP6_simyr2000_c240904.nc"
export fatmdomain="domain.lnd.1x1pt_ONAQ_navy.240904.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/ONAQ"
