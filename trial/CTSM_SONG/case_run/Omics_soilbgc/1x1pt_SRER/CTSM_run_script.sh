...
export CASE_NAME="control3"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_SRER"
...
then
	export CASE_SRC="${CTSM_folder}/case_run/${Project_folder}/1x1pt_SRER/control3_spinup/SourceMods/src.clm"
...
export Surface_data_spinup="${Surface_data}/SRER/1x1pt_SRER"
export Surface_data_final="${Surface_data}/SRER/1x1pt_SRER"
export Surface_data_hist="${Surface_data}/SRER/1x1pt_SRER"
export fsurf_data="surfdata_1x1pt_SRER_hist_78pfts_CMIP6_simyr2000_c240904.nc"
export fatmdomain="domain.lnd.1x1pt_SRER_navy.240605.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/SRER"
...
export DATM_CLMNCEP_YR_END_hist=2021
export DATM_CLMNCEP_YR_ALIGN_hist=2018
export JOB_WALLCLOCK_TIME_hist=00:25:00
export walltime_hist=00:25:00
...
Watsat_profile_file ='${CTSM_folder}/case_run/${Project_folder}/1x1pt_SRER/hydro_files/watsat_profile_S1.txt'
Sucsat_profile_file ='${CTSM_folder}/case_run/${Project_folder}/1x1pt_SRER/hydro_files/sucsat_profile_S1.txt'
B_profile_file ='${CTSM_folder}/case_run/${Project_folder}/1x1pt_SRER/hydro_files/bsw_profile_S1.txt'
EOF
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2018 2018 2021",
