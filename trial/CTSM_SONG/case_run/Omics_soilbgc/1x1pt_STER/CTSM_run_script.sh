...
export CASE_NAME="test1"
export Project_folder="Omics_soilbgc"
export Run_folder="1x1pt_STER"
...
export Surface_data_spinup="${Surface_data}/STER/1x1pt_STER"
export Surface_data_final="${Surface_data}/STER/1x1pt_STER"
export Surface_data_hist="${Surface_data}/STER/1x1pt_STER"
export fsurf_data="surfdata_1x1pt_STER_hist_78pfts_CMIP6_simyr2000_c240920.nc"
export fatmdomain="domain.lnd.1x1pt_STER_navy.240920.nc"
export Forcing="/home/u8/sdwilson/data/Omics_bgc/STER"
...
export RUN_STARTDATE_hist="2020-01-01"
export STOP_OPTION_hist=nyears
export STOP_N_hist=3
export RUN_TYPE_hist=startup
export DATM_CLMNCEP_YR_START_hist=2020
export DATM_CLMNCEP_YR_END_hist=2022
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2020 2020 2022",
