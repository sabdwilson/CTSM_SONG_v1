...
#export MYDATAFILES=/xdisk/chopinsong/chopinsong/CTSM_inputdata/lnd/clm2/mydatafile/
export MYDATAFILES=/groups/chopinsong/CTSM_projects/PTCLM/
export OUTPUT=/groups/chopinsong/CTSM_projects
export SITE=US-UMB
export TEST=testcase

export CASE1=1x1pt_$SITE"_spinup_"$TEST
export CASE2=1x1pt_$SITE"_spinup_final_"$TEST
export CASE3=1x1pt_$SITE"_hist_"$TEST
