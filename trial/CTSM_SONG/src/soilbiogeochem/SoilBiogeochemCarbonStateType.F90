...
contains
  ...
  subroutine InitHistory(this, bounds, carbon_type) 
    ...
    if (carbon_type == 'c12') then
       ...
       do l  = 1, ndecomp_pools
         ...
         ! print *, "hist_decomp_cpools_col_write",ndecomp_pools,l,data1dptr,fieldname,longname 
  ...
  subroutine InitCold(this, bounds, ratio, c12_soilbiogeochem_carbonstate_inst)
    ...
    do c = bounds%begc, bounds%endc
       ...
       if (lun%itype(l) == istsoil .or. lun%itype(l) == istcrop) then
          if (.not. present(c12_soilbiogeochem_carbonstate_inst)) then !c12
             ...
             do j = 1, nlevdecomp
               ...
               ! print *, "C state type cpool check 1", this%decomp_cpools_vr_col(c,j,k)
                end do
             ...
             do j = 1, nlevdecomp
              ...
              ! print *, "C state type cpool check 2", this%ctrunc_vr_col(c,j),this%decomp_cpools_vr_col(c,j,k)
             end do
             if ( nlevdecomp > 1 ) then
                do j = nlevdecomp+1, nlevdecomp_full
                   do k = 1, ndecomp_pools
       ...
       ! print *, "c state not use fates ctrunc check", this%ctrunc_col(c)
       end if
    end do
           ...
           do k = 1, ndecomp_pools
              ...
              do c = bounds%begc, bounds%endc
                 ...
                 do j = 1, nlevdecomp_full
                  ...
                  ! print *, "restart cpools", this%decomp_cpools_vr_col(c,j,k)
                 end do
              end do
           end do
        end if
  ...
  subroutine Summary(this, bounds, num_allc, filter_allc)
    ...
    do l = 1, ndecomp_pools
       do j = 1, nlevdecomp
          ...
          ! print *, "check C summary", this%decomp_cpools_col(c,l),this%decomp_cpools_vr_col(c,j,l),l
          end do
       end do
    end do
    ...
    if ( nlevdecomp > 1) then
       ...
       do l = 1, ndecomp_pools
          ...
          ! print *, "cpools_1m_col", this%decomp_cpools_1m_col(c,l),l
          end do
       end do
    ...
    if ( nlevdecomp_full > 1 ) then
       ...
       ! print *, "decomp_soilc", this%decomp_soilc_vr_col(c,j)
    end if
    ...
    do j = 1, nlevdecomp
       do fc = 1,num_allc
        ...
        !print *, "ctrunc summary", this%ctrunc_col(c), this%ctrunc_vr_col(c,j)
       end do
    end do
       ...
       do l = 1, ndecomp_pools
          if ( decomp_cascade_con%is_soil(l) ) then
             do fc = 1,num_allc
              ...
              !  print *, "totsomc_1m_col(c)",this%totsomc_1m_col(c)
             end do
          end if
       end do
    end if
...
!           print *, "totsomc_col(c)",this%totsomc_col(c)
          end do
       end if
    end do
