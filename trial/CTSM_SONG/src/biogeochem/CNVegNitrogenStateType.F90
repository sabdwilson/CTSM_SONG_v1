...
contains
  ...
  subroutine Summary_nitrogenstate(this, bounds, num_allc, filter_allc, &
    ...
    do fc = 1,num_allc
     ...
     ! print *,"N check", c, this%totn_p2c_col(c),soilbiogeochem_nitrogenstate_inst%cwdn_col(c),soilbiogeochem_nitrogenstate_inst%totlitn_col(c),&
     !           soilbiogeochem_nitrogenstate_inst%totsomn_col(c),soilbiogeochem_nitrogenstate_inst%sminn_col(c),soilbiogeochem_nitrogenstate_inst%ntrunc_col(c)
    end do
