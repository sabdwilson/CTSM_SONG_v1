...
lon = np.array([[249.4375]]);   lai = np.array([[44.9375]])
lat_wkg = 44.9375; lon_wkg = -110.5625
edgew = np.array([249.4375]); edgee = np.array([249.4375])
edges = np.array([44.975]);   edgen = np.array([44.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/Omics_bgc"+\
                      "/YELL/1x1pt_YELL/CLM1PT_data/{strs}.nc".\
