...
lon = np.array([[249.1875]]);   lai = np.array([[31.9375]])
lat_wkg = 31.9375; lon_wkg = -110.8125
edgew = np.array([249.1875]); edgee = np.array([249.1875])
edges = np.array([31.9375]);   edgen = np.array([31.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/Omics_bgc"+\
                      "/SRER/1x1pt_SRER/CLM1PT_data/{strs}.nc".\
