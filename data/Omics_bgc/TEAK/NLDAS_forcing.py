...
lon = np.array([[240.9375]]);   lai = np.array([[37.0625]])
lat_wkg = 37.0625; lon_wkg = -119.0625
edgew = np.array([240.9375]); edgee = np.array([240.9375])
edges = np.array([37.0625]);   edgen = np.array([37.0625])

'''Read variables'''
start_yr = 2021; end_year = 2024
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/Omics_bgc"+\
                      "/TEAK/1x1pt_TEAK/CLM1PT_data/{strs}.nc".\
