...
lon = np.array([[261.8125]]);   lai = np.array([[47.1875]])
lat_wkg = 47.1875; lon_wkg = -98.1875
edgew = np.array([261.8125]); edgee = np.array([261.8125])
edges = np.array([47.1875]);   edgen = np.array([47.1875])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/Omics_bgc"+\
                      "/WOOD/1x1pt_WOOD/CLM1PT_data/{strs}.nc".\
