...
lon = np.array([[263.4375]]);   lai = np.array([[39.0625]])
lat_wkg = 39.0625; lon_wkg = -96.5625
edgew = np.array([263.4375]); edgee = np.array([263.4375])
edges = np.array([39.0625]);   edgen = np.array([39.0625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/Omics_bgc"+\
                      "/KNOZ/1x1pt_KNOZ/CLM1PT_data/{strs}.nc".\
