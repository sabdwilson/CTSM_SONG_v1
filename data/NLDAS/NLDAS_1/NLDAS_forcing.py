...
lon = np.array([[262.4375]]);   lai = np.array([[33.4375]])
lat_wkg = 33.4375; lon_wkg = -97.5625
edgew = np.array([262.4375]); edgee = np.array([262.4375])
edges = np.array([33.4375]);   edgen = np.array([33.4375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/Omics_bgc"+\
                      "/CLBJ/1x1pt_CLBJ/CLM1PT_data/{strs}.nc".\
