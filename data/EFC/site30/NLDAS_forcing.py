...
lon = np.array([[248.1875]]);   lai = np.array([[41.0625]])
lat_wkg = 41.0625; lon_wkg = -111.8125
edgew = np.array([248.1875]); edgee = np.array([248.1875])
edges = np.array([41.0625]);   edgen = np.array([41.0625])

'''Read variables'''
start_yr = 1979; end_year = 1981
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site30/1x1pt_site30/CLM1PT_data/{strs}.nc".\
