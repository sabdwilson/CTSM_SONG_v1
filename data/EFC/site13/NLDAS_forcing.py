...
lon = np.array([[260.9375]]);   lai = np.array([[39.0625]])
lat_wkg = 39.0625; lon_wkg = -99.0625
edgew = np.array([260.9375]); edgee = np.array([260.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site13/1x1pt_site13/CLM1PT_data/{strs}.nc".\
