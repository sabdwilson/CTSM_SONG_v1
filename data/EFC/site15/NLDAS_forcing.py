...
lon = np.array([[238.6875]]);   lai = np.array([[39.1875]])
lat_wkg = 39.1875; lon_wkg = -121.3125
edgew = np.array([238.6875]); edgee = np.array([238.6875])
edges = np.array([39.1875]);   edgen = np.array([39.1875])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site15/1x1pt_site15/CLM1PT_data/{strs}.nc".\
