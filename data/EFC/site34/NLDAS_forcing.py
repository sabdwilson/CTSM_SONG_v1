...
lon = np.array([[270.5625]]);   lai = np.array([[42.3125]])
lat_wkg = 42.3125; lon_wkg = -89.4375
edgew = np.array([270.5625]); edgee = np.array([270.5625])
edges = np.array([42.3125]);   edgen = np.array([42.3125])

'''Read variables'''
start_yr = 2011; end_year = 2013
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site34/1x1pt_site34/CLM1PT_data/{strs}.nc".\
