...
lon = np.array([[274.6875]]);   lai = np.array([[30.3125]])
lat_wkg = 42.3125; lon_wkg = -85.3125
edgew = np.array([274.6875]); edgee = np.array([274.6875])
edges = np.array([42.3125]);   edgen = np.array([42.3125])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site33/1x1pt_site33/CLM1PT_data/{strs}.nc".\
