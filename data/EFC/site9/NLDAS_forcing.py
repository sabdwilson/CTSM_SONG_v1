...
lon = np.array([[288.5625]]);   lai = np.array([[43.5625]])
lat_wkg = 43.5625; lon_wkg = -71.4375
edgew = np.array([288.5625]); edgee = np.array([288.5625])
edges = np.array([43.5625]);   edgen = np.array([43.5625])

'''Read variables'''
start_yr = 2009; end_year = 2015
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site9/1x1pt_site9/CLM1PT_data/{strs}.nc".\
