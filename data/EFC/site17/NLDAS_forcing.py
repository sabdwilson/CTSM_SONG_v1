...
lon = np.array([[287.8125]]);   lai = np.array([[42.5625]])
lat_wkg = 42.5625; lon_wkg = -72.1875
edgew = np.array([287.8125]); edgee = np.array([287.8125])
edges = np.array([42.5625]);   edgen = np.array([42.5625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site17/1x1pt_site17/CLM1PT_data/{strs}.nc".\
