...
lon = np.array([[236.3125]]);   lai = np.array([[39.6875]])
lat_wkg = 39.6875; lon_wkg = -123.6875
edgew = np.array([236.3125]); edgee = np.array([236.3125])
edges = np.array([39.6875]);   edgen = np.array([39.6875])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site39/1x1pt_site39/CLM1PT_data/{strs}.nc".\
