...
lon = np.array([[239.3125]]);   lai = np.array([[38.8125]])
lat_wkg = 38.8125; lon_wkg = -120.6875
edgew = np.array([239.3125]); edgee = np.array([239.3125])
edges = np.array([38.8125]);   edgen = np.array([38.8125])

'''Read variables'''
start_yr = 2010; end_year = 2012
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site6/1x1pt_site6/CLM1PT_data/{strs}.nc".\
