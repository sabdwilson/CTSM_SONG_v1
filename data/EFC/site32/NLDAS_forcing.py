...
lon = np.array([[248.1875]]);   lai = np.array([[41.6875]])
lat_wkg = 41.6875; lon_wkg = -111.8125
edgew = np.array([248.1875]); edgee = np.array([248.1875])
edges = np.array([41.6875]);   edgen = np.array([41.6875])

'''Read variables'''
start_yr = 2013; end_year = 2015
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site32/1x1pt_site32/CLM1PT_data/{strs}.nc".\
