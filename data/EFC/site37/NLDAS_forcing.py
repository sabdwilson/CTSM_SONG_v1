...
lon = np.array([[249.4375]]);   lai = np.array([[45.6875]])
lat_wkg = 45.6875; lon_wkg = -110.5625
edgew = np.array([249.4375]); edgee = np.array([249.4375])
edges = np.array([45.6875]);   edgen = np.array([45.6875])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site37/1x1pt_site37/CLM1PT_data/{strs}.nc".\
