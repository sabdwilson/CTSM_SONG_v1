...
lon = np.array([[270.8125]]);   lai = np.array([[30.3125]])
lat_wkg = 43.3125; lon_wkg = -89.1875
edgew = np.array([270.8125]); edgee = np.array([270.8125])
edges = np.array([43.3125]);   edgen = np.array([43.3125])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site21/1x1pt_site21/CLM1PT_data/{strs}.nc".\
