...
lon = np.array([[237.8125]]);   lai = np.array([[30.3125]])
lat_wkg = 44.1875; lon_wkg = -122.1875
edgew = np.array([237.8125]); edgee = np.array([237.8125])
edges = np.array([44.1875]);   edgen = np.array([44.1875])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site18/1x1pt_site18/CLM1PT_data/{strs}.nc".\
