...
lon = np.array([[264.8125]]);   lai = np.array([[31.0625]])
lat_wkg = 31.0625; lon_wkg = -95.1875
edgew = np.array([264.8125]); edgee = np.array([264.8125])
edges = np.array([31.0625]);   edgen = np.array([31.0625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site5/1x1pt_site5/CLM1PT_data/{strs}.nc".\
