...
lon = np.array([[266.9375]]);   lai = np.array([[41.8125]])
lat_wkg = 41.8125; lon_wkg = -93.0625
edgew = np.array([266.9375]); edgee = np.array([266.9375])
edges = np.array([41.8125]);   edgen = np.array([41.8125])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site20/1x1pt_site20/CLM1PT_data/{strs}.nc".\
