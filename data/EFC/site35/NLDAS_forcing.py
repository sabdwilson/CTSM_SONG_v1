...
lon = np.array([[250.3125]]);   lai = np.array([[44.4375]])
lat_wkg = 44.4375; lon_wkg = -109.6875
edgew = np.array([250.3125]); edgee = np.array([250.3125])
edges = np.array([44.4375]);   edgen = np.array([44.4375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site35/1x1pt_site35/CLM1PT_data/{strs}.nc".\
