...
lon = np.array([[248.3125]]);   lai = np.array([[35.0625]])
lat_wkg = 35.0625; lon_wkg = -111.6875
edgew = np.array([248.3125]); edgee = np.array([248.3125])
edges = np.array([35.0625]);   edgen = np.array([35.0625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site24/1x1pt_site24/CLM1PT_data/{strs}.nc".\
