...
lon = np.array([[237.5625]]);   lai = np.array([[38.8125]])
lat_wkg = 38.8125; lon_wkg = -122.4375
edgew = np.array([237.5625]); edgee = np.array([237.5625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site10/1x1pt_site10/CLM1PT_data/{strs}.nc".\
