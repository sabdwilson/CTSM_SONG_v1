...
lon = np.array([[280.9375]]);   lai = np.array([[35.9375]])
lat_wkg = 35.9375; lon_wkg = -79.0625
edgew = np.array([280.9375]); edgee = np.array([280.9375])
edges = np.array([35.9375]);   edgen = np.array([35.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site11/1x1pt_site11/CLM1PT_data/{strs}.nc".\
