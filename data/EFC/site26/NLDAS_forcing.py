...
lon = np.array([[278.0625]]);   lai = np.array([[38.0625]])
lat_wkg = 38.0625; lon_wkg = -81.9375
edgew = np.array([278.0625]); edgee = np.array([278.0625])
edges = np.array([38.0625]);   edgen = np.array([38.0625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site26/1x1pt_site26/CLM1PT_data/{strs}.nc".\
