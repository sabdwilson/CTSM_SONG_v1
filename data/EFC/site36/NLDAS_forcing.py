...
lon = np.array([[249.1875]]);   lai = np.array([[45.3125]])
lat_wkg = 45.3125; lon_wkg = -110.8125
edgew = np.array([249.1875]); edgee = np.array([249.1875])
edges = np.array([45.3125]);   edgen = np.array([45.3125])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site36/1x1pt_site36/CLM1PT_data/{strs}.nc".\
