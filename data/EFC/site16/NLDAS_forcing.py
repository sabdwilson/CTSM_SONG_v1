...
lon = np.array([[255.1875]]);   lai = np.array([[40.8125]])
lat_wkg = 40.8125; lon_wkg = -104.8125
edgew = np.array([255.1875]); edgee = np.array([255.1875])
edges = np.array([40.8125]);   edgen = np.array([40.8125])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site16/1x1pt_site16/CLM1PT_data/{strs}.nc".\
