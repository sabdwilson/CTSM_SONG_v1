...
lon = np.array([[248.0625]]);   lai = np.array([[41.1875]])
lat_wkg = 41.1875; lon_wkg = -111.9375
edgew = np.array([248.0625]); edgee = np.array([248.0625])
edges = np.array([41.1875]);   edgen = np.array([41.1875])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site31/1x1pt_site31/CLM1PT_data/{strs}.nc".\
