...
lon = np.array([[262.4375]]);   lai = np.array([[34.9375]])
lat_wkg = 34.9375; lon_wkg = -97.5625
edgew = np.array([262.4375]); edgee = np.array([262.4375])
edges = np.array([34.9375]);   edgen = np.array([34.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site23/1x1pt_site23/CLM1PT_data/{strs}.nc".\
