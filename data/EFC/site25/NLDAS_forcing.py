...
lon = np.array([[250.4375]]);   lai = np.array([[37.9375]])
lat_wkg = 37.9375; lon_wkg = -109.5625
edgew = np.array([250.4375]); edgee = np.array([250.4375])
edges = np.array([37.9375]);   edgen = np.array([37.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site25/1x1pt_site25/CLM1PT_data/{strs}.nc".\
