...
lon = np.array([[283.5625]]);   lai = np.array([[42.4375]])
lat_wkg = 42.4375; lon_wkg = -76.4375
edgew = np.array([283.5625]); edgee = np.array([283.5625])
edges = np.array([42.4375]);   edgen = np.array([42.4375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site4/1x1pt_site4/CLM1PT_data/{strs}.nc".\
