...
lon = np.array([[276.0625]]);   lai = np.array([[35.8125]])
lat_wkg = 35.8125; lon_wkg = -83.9375
edgew = np.array([276.0625]); edgee = np.array([276.0625])
edges = np.array([35.8125]);   edgen = np.array([35.8125])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site2/1x1pt_site2/CLM1PT_data/{strs}.nc".\
