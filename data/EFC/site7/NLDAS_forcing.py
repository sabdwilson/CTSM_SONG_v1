...
lon = np.array([[253.0625]]);   lai = np.array([[38.9375]])
lat_wkg = 38.9375; lon_wkg = -106.9375
edgew = np.array([253.0625]); edgee = np.array([253.0625])
edges = np.array([38.9375]);   edgen = np.array([38.9375])

'''Read variables'''
start_yr = 2016; end_year = 2018
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site7/1x1pt_site7/CLM1PT_data/{strs}.nc".\
