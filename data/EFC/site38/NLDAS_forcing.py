...
lon = np.array([[266.5625]]);   lai = np.array([[47.5625]])
lat_wkg = 47.5625; lon_wkg = -93.4375
edgew = np.array([266.5625]); edgee = np.array([266.5625])
edges = np.array([47.5625]);   edgen = np.array([47.5625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site38/1x1pt_site38/CLM1PT_data/{strs}.nc".\
