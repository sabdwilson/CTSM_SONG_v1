...
lon = np.array([[236.9375]]);   lai = np.array([[39.9375]])
lat_wkg = 39.9375; lon_wkg = -123.0625
edgew = np.array([236.9375]); edgee = np.array([236.9375])
edges = np.array([39.9375]);   edgen = np.array([39.9375])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site8/1x1pt_site8/CLM1PT_data/{strs}.nc".\
