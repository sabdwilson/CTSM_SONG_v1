...
lon = np.array([[250.9375]]);   lai = np.array([[33.5625]])
lat_wkg = 33.5625; lon_wkg = -109.0625
edgew = np.array([250.9375]); edgee = np.array([250.9375])
edges = np.array([33.5625]);   edgen = np.array([33.5625])
...
for i in range(1, nmonth+1, 1):
    ...
    ds_test.to_netcdf("/home/u8/sdwilson/data/EFC"+\
                      "/site22/1x1pt_site22/CLM1PT_data/{strs}.nc".\
